...
export declare namespace PetShopee {
...
export interface PetShopeeInterface extends utils.Interface {
  functions: {
...
export interface PetShopee extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PetShopeeInterface;
  ...
  functions: {
    ...
    ): Promise<[PetShopee.ListDetailStructOutput[]]>;
