...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "PETICO",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.PETICO__factory>;
    getContractFactory(
      name: "PetShopee",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.PetShopee__factory>;
    getContractFactory(
      name: "PetToken",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.PetToken__factory>;
    getContractFactory(
      name: "SimpleToken",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.PETICO>;
    getContractAt(
      name: "PetShopee",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.PetShopee>;
    getContractAt(
      name: "PetToken",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.PetToken>;
    getContractAt(
      name: "SimpleToken",
      address: string,
      signer?: ethers.Signer
